	...
	return (
		<section className="relative flex flex-col  py-16 px-8 md:p-16 bg-(--background)">
			<SectionContainer>
				...
				<h1 className="text-balance mt-4 text-[2rem] font-bold leading-[1.2] tracking-[-0.02em] text-(--foreground) sm:text-[2.35rem] lg:text-[3.05rem]">Vårt sortiment av <em className="font-semibold italic text-[#c8d7c9]">bommar</em></h1>
